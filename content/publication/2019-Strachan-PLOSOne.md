...
authors = ["**Strachan, J.W.A.**", "Sebanz, N.", "Knoblich, G."]
...
abstract_short = "Previous research has shown that we are better able to visually process two individuals (a dyad) if they are facing each other as opposed to looking away from each other. Previously, this effect has been shown with images of full bodies. We replicate and extend this finding using faces, and show that this perceptual grouping of facing dyads is affected by the emotional expression of the individuals."
